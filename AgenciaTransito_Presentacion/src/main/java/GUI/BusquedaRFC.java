...
public class BusquedaRFC extends javax.swing.JFrame {
    ...
    RegistroPlacasBO registroPlacasBO = new RegistroPlacasBO();
     ...
     * @param opcion
     */
    public BusquedaRFC(int op) {
        this.opcion = op;
        initComponents();
        botonSiguiente.setVisible(false);
        if (op == 2) {
            this.txtTitulo.setText("TRÁMITE DE PLACAS");
        }
    }
    ...
    private void initComponents() {
        ...
        txtTitulo.setFont(new java.awt.Font("Segoe UI", 3, 36)); // NOI18N
        txtTitulo.setForeground(new java.awt.Color(255, 255, 255));
        txtTitulo.setText("TRÁMITE DE LICENCIAS");
        ...
        txtSubtitulo.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        txtSubtitulo.setForeground(new java.awt.Color(0, 0, 0));
        txtSubtitulo.setText("Ingrese su RFC para verificar su existencia en los registros");
        panelBlanco.add(txtSubtitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 101, -1, -1));
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        if (opcion == 2) {
            try {
                ...
                personaDTO = registroPlacasBO.buscarPersonaPorRFC(txtFieldRFC.getText());
